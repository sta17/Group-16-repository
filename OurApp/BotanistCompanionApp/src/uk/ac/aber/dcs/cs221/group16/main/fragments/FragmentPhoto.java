...
import uk.ac.aber.dcs.cs221.group16.util.ExifUtil;
...
public class FragmentPhoto extends Fragment {
	...
	private void SetupButtons() {
		...
		PNext.setOnClickListener(new OnClickListener() {
			/**
			 * Goes to next page(gps), stores values as well as putting this fragment on top of
		...
		area.setOnClickListener(new OnClickListener() {
			/**
			 * 
			 * Makes it so that when the area photo button is pressed options pop up
			 * @see SelectImage(AREA)
			 */
			@Override
			public void onClick(View arg0) {
				selectImage(AREA);
		...
		plant.setOnClickListener(new OnClickListener() {
			/**
			 * 
			 * Makes it so that when the plant photo button is pressed options pop up
			 * @see SelectImage(PLANT)
			 */
			@Override
			public void onClick(View arg0) {
				selectImage(PLANT);
	...
	public void updateImage(Record temp) {
		...
		if (rec != null) {
			...
			if (rec.getSceneIMGPath() != null || rec.getSceneIMGPath() == "No image taken") {
			...
			if (rec.getSpecimenIMGPath() != null || rec.getSpecimenIMGPath() == "No image taken") {
